...
public class EtcdComponent extends UriEndpointComponent {
	...
	public EtcdComponent(CamelContext context) {
		super(context, EtcdEndpoint.class);
	}
	...
	protected Endpoint createEndpoint(String uri, String remaining,
		...
		setProperties(etcdConfiguration, parameters);
		
		etcdConfiguration.setUri(remaining);
		
		EtcdEndpoint endpoint = new EtcdEndpoint(uri, this, etcdConfiguration);
