...
public class ObjectFactory {
    ...
    private final static QName _Empresa_QNAME = new QName("http://soaexpert.com.br/domain", "empresa");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaexpert.com.br/domain", name = "empresa")
